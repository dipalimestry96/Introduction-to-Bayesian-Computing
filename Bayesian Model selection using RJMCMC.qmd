...
Three bijection maps and their inverse map is needed for implementation of RJMCMC algorithm. Graphical representation of transitions between parameter spaces and universal parameter $\psi$ using bijection map and their inverse map is depicted in following figure;
